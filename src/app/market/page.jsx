...
const ProductSelector = () => {
  ...
  return (
    <main className='h-screen md:h-[calc(100vh-8rem)]'>
      <div className='flex flex-col gap-4 mt-4 mb-6'>
        <h1 className='text-xl md:text-4xl'>Explore our <span className='font-bold text-orange-600'>huge library !!</span></h1>
        <h2 className=' text-lg md:text-2xl'>We update our stock every day !!</h2>
